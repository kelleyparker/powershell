# Create 1 VM per iso located in a specific folder.  For me, I use D:\isos.  Change $ISO path to the folder that has all your ISOs.  Change VMpath as well if you don't want to store your VMs on C:\VMs
# Set variables
